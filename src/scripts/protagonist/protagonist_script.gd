...
func _handle_move_input():
	...
	velocity.x = lerp(velocity.x, adjusted_move_x * move_speed * sprint_modifier, _get_h_weight())
	velocity.z = lerp(velocity.z, adjusted_move_z * move_speed * sprint_modifier, _get_h_weight())
